...
const BlogsPage: FC = () => {
  ...
  const getStatusLabel = (status: string, publishStatus?: string) => {
    ...
    if (status === 'IMAGE_PENDING') return 'Draft';
    return status || 'Draft';
  };
    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        >
          ...
          <option value="IMAGE_PENDING">Draft</option>
          ...
          {pagination.totalPages > 1 && (
            <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
              <button
                ...
                className="px-4 py-2 rounded-lg bg-[#1b2138]/80 border border-blue-500/20 text-white disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#1b2138] transition-colors text-sm inline-flex items-center gap-1.5"
              >
                <ChevronLeft size={16} />
                Previous
              </button>
