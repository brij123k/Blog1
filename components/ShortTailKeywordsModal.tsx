...
interface ShortTailKeywordsModalProps {
  onClose: () => void;
  onSave: (keywords: string[]) => void;
  availableKeywords: string[];   // full list from store analysis
  initialSelected: string[];     // currently saved selection (with custom ones)
}

const ShortTailKeywordsModal: FC<ShortTailKeywordsModalProps> = ({
  onClose,
  onSave,
  availableKeywords = [],
  initialSelected = [],
    ...
    <div className="ov open">
      ...
      <div className="cardhost open" style={{ maxWidth: "650px" }}>
        <div className="card">
          ...
          <div className="sub">
            Select keywords from the list or add your own (max 20)
          </div>
          ...
          <div className="wiz-foot">
            <span className="muted">{selected.size} / 20 selected</span>
...
export default ShortTailKeywordsModal;